...
<div id="tambah-modal" class="modal-demo">
  ...
  <div class="custom-modal-text">
    ...
    <div class="text-center">
      <h4 class="text-uppercase font-bold mb-0">Tambah Program Studi</h4>
    </div>
    <div class="text-left">
      <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="<?php echo e(route('prodi.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>

        <div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="text" autocomplete="off" name="nama" required="" placeholder="Nama Program Studi">
          </div>
        </div>
...
<div id="edit-modal" class="modal-demo">
  ...
  <div class="custom-modal-text">
    ...
    <div class="text-center">
      <h4 class="text-uppercase font-bold mb-0">Edit Program Studi</h4>
    </div>
    <div class="text-left">
      ...
      <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="<?php echo e(route('prodi.store')); ?>" method="POST">
        ...
        <div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="text" autocomplete="off" id="edit_nama" name="nama" required="" placeholder="Nama Program Studi">
          </div>
        </div>
...
<div id="hapus-modal" class="modal-demo">
  ...
  <div class="custom-modal-text">
    ...
    <div class="text-center">
      <h4 class="text-uppercase font-bold mb-0">Hapus Program Studi</h4>
    </div>
    <div class="">

      <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="<?php echo e(route('prodi.hapus')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div>
          <input type="hidden" id='id_hapus' name='id'>
          <h5 id="exampleModalLabel">Apakah anda yakin ingin mengapus program studi ini?</h5>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistem-informasi-pengajuan-magang-umri\resources\views/admin/prodi/index.blade.php ENDPATH**/ ?>