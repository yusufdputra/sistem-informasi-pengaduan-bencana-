...
<div id="tambah-modal" class="modal-demo">
  ...
  <div class="custom-modal-text">
    ...
    <div class="text-left">
      <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('prodi.store')}}" method="POST">
        @csrf
...
<div id="hapus-modal" class="modal-demo">
  ...
  <div class="custom-modal-text">
    ...
    <div class="">
      ...
      <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('prodi.hapus')}}" method="POST">
        @csrf
        <div>
