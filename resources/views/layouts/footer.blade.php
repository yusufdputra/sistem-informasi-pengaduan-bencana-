...
<!-- Magnific Popup-->
<script src="{{asset('atlantis/libs/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
...
<script src="{{asset('atlantis/libs/flatpickr/flatpickr.min.js')}}"></script>
<script src="{{asset('atlantis/libs/spectrum-colorpicker2/spectrum.min.js')}}"></script>

<script src="{{asset('atlantis/libs/clockpicker/bootstrap-clockpicker.min.js')}}"></script>
<script src="{{asset('atlantis/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}"></script>


<!-- Plugin js-->
<script src="{{asset('atlantis/libs/parsleyjs/parsley.min.js')}}"></script>
<!-- Validation init js-->
<script src="{{asset('atlantis/js/pages/form-validation.init.js')}}"></script>
<!-- Init js-->
<script src="{{asset('atlantis/js/pages/form-pickers.init.js')}}"></script>
